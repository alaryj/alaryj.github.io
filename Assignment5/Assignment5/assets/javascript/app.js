...
var triviaQuestions = [{
    ...
    answerList: ["Yellow Jacket Boys", "The Pecan Sandies", "The Freight Train", "Dirty Deeds"],
    answer: 0
},{
    question: "What was Dee's nickname in highschool?",
    answerList: ["Fatty Magoo", "The Gangly Bird", "The Aluminum Monster", "The Truck"],
    answer: 2
},{
    question: "What name do Dennis, Mac, and Charlie wrestle under when they put on a show for the troops?",
    answerList: ["The Eagles of Pain", "The Fowl of Action", "War Birds", "The Birds of War"],
    answer: 3
},{
    ...
    answerList: ["Milk, yoghurt and rum", "Milk, eggs and vodka", "Milk, cat food and tequila", "Milk, ketchup and whiskey"],
    answer: 1
},{
    question: "What is Mac and Charlie's shared annual Christmas tradition?",
    answerList: ["Throwing rocks at trains.", "Breaking into houses together to steal presents.", "Attending midnight mass.", "Delivering stolen presents to the orphanage."],
    answer: 0
},{
    question: "What's the flip cup drinking game that Paddy's Pub has been banned from (twice)?",
    answerList: ["Flip Cup Championships", "Flipsylvania", "Flipadelphia", "Fliperty Bell"],
    answer: 2   
},{
